...
var LOGISTICS_HELPERS = {
  ...
  "JOUR1_OPENING_CEREMONY": {
    ...
    apres: "<div><span style=\"font-family: Calibri; font-size: 11pt;\">•&nbsp;</span>Message aimable pour les personnes qui tardent à aller au restaurant : \" c'est l'heure de se diriger vers le restau (reprise à 21h !) donc ne pas trainer !\"</div>",
    updatedAt: "2026-08-29 13:18"
  },

  "JOUR1_SOIREE_ECSTATIC_DANSE": {
    avant: "Préparer l'espace sur le plan énergétique (purification) <br>Accueillir les participants à leur arrivée<br>Purifier les participants (au palo santo, à la sauge ou à l'encens). <br>J'aimerais les rencontrer environ une heure avant le début de la séance.",
    pendant: "Helpers jouent le rôle de gardiens de l'espace pendant la danse. <br>Pour permettre à chacun de s'immerger pleinement dans la danse, ils peuvent, si nécessaire, demander gentiment aux participants de s'abstenir de parler.",
    apres: "1 helper pour rapporter les instruments",
  ...
  "JOUR2_INMEN___HELD_BY_MEN_A_SOMATIC_": {
    avant: "Purifier la pièce à la sauge <br>Tester le son et le micro<br><br>Venez l'esprit serein, détendu et prêt à apporter un soutien émotionnel. Si vous n'êtes pas disponible, merci de me le faire savoir.",
    pendant: "Être présent avec un regard bienveillant et disponible. <br>Si besoin, apporter un soutien émotionnel pour aider à l'ancrage des participants uniquement. Il ne s'agit pas d'une séance de thérapie ou de guérison. <br>Si besoin, faire appel au facilitateur pour obtenir de l'aide.",
    apres: "Se remercier mutuellement par un hug <br>Purifier la pièce à la sauge/palo santo.",
    updatedAt: "2026-08-26 18:36"
  },

  "JOUR2_LA_DANSE_DE_LA_POLARITE": {
    avant: "",
    pendant: "Aucun besoin spécifique mais un soutien énergétique sera apprécié",
    apres: "",
    updatedAt: "2026-08-25 03:37"
  },

  "JOUR2_LA_SAVEUR_DU_DESIR_": {
    avant: "Informer les participant.e.s qu'il ne faut pas toucher à la table au centre de la pièce",
    pendant: "Accepter le départ pour ceux qui souhaitent quitter l'atelier en cours de route, aucun problème.<br>Ne pas accepter d'entrée en cours d'atelier",
    apres: "Rediriger les participant.e.s vers la table qui sera près de la porte pour laisser leurs coordonnées ou prendre des cartes/flyers<br>Ranger la salle",
    updatedAt: "2026-08-26 18:36"
  },

  "JOUR2_L_UNION_SACREE_D_HATHOR_ET_HOR": {
    avant: "Installer les matelas",
    pendant: "Soutien logistique et émotionnel",
    apres: "Rangement du matériel<br>Nettoyage de salle",
    updatedAt: "2026-08-26 18:36"
  },

  "JOUR2_MEETING_YOUR_DEITY___HYPNOSIS_": {
    avant: "Faire un test son (enceintes, micro, musique)<br>Installez les matelas et les chaises et tables",
    pendant: "Pendant l’atelier, les assistants pourront s’asseoir pendant la première partie consacrée à l’hypnose.<br>Des « anges » seront là pour apporter leur soutien si quelqu’un a besoin d’aide pendant la séance d’hypnose. <br>Les participants pourraient avoir besoin de l’aide des assistants pour organiser leur matériel artistique ou réaliser leur collage.",
    apres: "Ranger le matériel d'art<br>Ranger les matelas et chaises",
    updatedAt: "2026-08-26 18:36"
  },
  ...
  "JOUR2__CALL__POUR_RASSEMBLEMENT": {
    ...
    pendant: "",
    apres: "",
    updatedAt: "2026-08-25 10:18"
  },

  "JOUR2____STAND__MAQUILLAGE___": {
    avant: "",
    pendant: "",
    apres: "",
    updatedAt: "2026-08-24 01:27"
  },

  "JOUR3_ALCHIMIE_DU_COEUR__DANSE_M_DEC": {
    avant: "Preparer le son , surtout si musicien",
    pendant: "",
    apres: "Ranger la salle",
    updatedAt: "2026-08-25 03:37"
  },
  ...
  "JOUR3_DANCING_EROS": {
    avant: "Purifier la pièce à la sauge <br>Tester le son et le micro<br><br>Venez l'esprit serein, détendu et prêt à apporter un soutien émotionnel. Si vous n'êtes pas disponible, merci de me le faire savoir.",
    pendant: "Assurer une présence discrète avec un regard bienveillant et disponible<br>Si besoin, apporter un soutien émotionnel pour aider à l'ancrage des participants uniquement. Il ne s'agit pas d'une séance de thérapie ou de guérison. <br>Si besoin, faire appel au facilitateur pour obtenir de l'aide.",
    apres: "Se remercier mutuellement par un hug <br>Purifier la pièce à la sauge/palo santo.",
    updatedAt: "2026-08-26 18:36"
  },
  ...
  "JOUR3_DANSE_ORGASMIQUE___DANSER_LA_J": {
    avant: "Ouvrir la salle, s'assurer que tout est ok",
    pendant: "Apporter les coussins",
    apres: "Ranger la salle",
    updatedAt: "2026-08-25 03:37"
  },
  ...
  "JOUR3_INITIATION_A__LA_DANSE_FUSION": {
    avant: "Faire un test son (enceintes, micro, musique)",
    pendant: "",
    apres: "",
    updatedAt: "2026-08-26 18:36"
  },
  ...
  "JOUR3_LOVE_TEMPLE_DES_EROTYPES__R": {
    avant: "2 helpers pour accueil, jauge, installation  salle",
    pendant: "2 helpers pour rangement salle",
    apres: "2 helpers pour rangement salle",
    updatedAt: "2026-08-25 03:37"
  },
  ...
  "JOUR3_VOYAGE_AVEC_LA_ROSE__FEMMES_": {
    avant: "Installer les coussins<br>Préparer plateau + gobelets pour tisane",
    pendant: "Distribuer gobelets tisane, <br>Enlever coussins pendant la structure et <br>Tenir l'espace énergétique et si besoins dans l'instant",
    apres: "Aider au rangement",
    updatedAt: "2026-08-26 18:36"
  },
  ...
  "JOUR4_DANSE_FUSION___GUIDER___SE_LAI": {
    avant: "Faire un test son (enceintes, micro, musique)",
    pendant: "Distribuer les bandeaux",
    apres: "Récupérer les bandeaux",
    updatedAt: "2026-08-26 18:36"
  },

  "JOUR4_ECSTATIC_DANCE_EN_SILENT_DISCO": {
    avant: "Rappeler aux participants le respect des 4 règles si besoin : No shoes, No talk, No phone, No alcool/drug",
    pendant: "Rappeler aux participants le respect des 4 règles si besoin : No shoes, No talk, No phone, No alcool/drug",
    apres: "",
    updatedAt: "2026-08-25 03:37"
  },

  "JOUR4_LA_MERKABA_TANTRIQUE_": {
    ...
    apres: "Retirer autel + fil et objets suspendus / rangement matelas et coussins par les participants.es",
    updatedAt: "2026-08-25 03:37"
  },
  ...
  "JOUR4_PREPARATION_RASSEMBLEMENT": {
    ...
    pendant: "",
    apres: "",
    updatedAt: "2026-08-25 10:14"
  },

  "JOUR4_RELEASING_SEXUAL_SHAME___CONDI": {
    avant: "Faire un test son (enceintes, micro, musique)<br>Installler les chaises",
    pendant: "Pendant l’atelier, des assistants pourront être nécessaires pour reculer les chaises, mais selon la taille du groupe, celles-ci pourront rester disposées en cercle. <br>Les « anges » seront indispensables pour offrir des câlins, apporter des mouchoirs ou prendre des nouvelles pendant et après l’atelier. <br>Cet atelier suscite souvent de vives émotions.",
    apres: "Les « anges » seront indispensables pour offrir des câlins, apporter un soutien avec des mouchoirs ou prendre des nouvelles pendant et après l’atelier. Cet atelier suscite souvent de vives émotions.",
    updatedAt: "2026-08-26 18:36"
  },
  ...
  "JOUR4_ROUE_DE_L_EAU___ROUE_DU_CONSEN": {
    ...
    pendant: "faire une ronde de matelas pour la partie 2, <br><br>1re partie: debout dans le cercle tracé<br>2e partie: à deux sur les matelas avec circulation<br>3e partie: massage à deux",
    apres: "ranger",
    updatedAt: "2026-08-25 03:58"
  },
  ...
  "JOUR4_THE_ART_OF_KISSING_": {
    avant: "H-30’ Installer matelas (1 par Duo soit 10 à 15 matelas au total ) installés en cercle autour du matelas de démo <br>Accrocher des photos A3 au mur  (9 x 3 pinces métaliques)<br>H-15 Découper fruits <br>Vérifier la sono",
    pendant: "Distribuer assiettes fruits ou chocolats / beaume ...",
    apres: "Ranger, décrocher photos",
    updatedAt: "2026-08-26 18:36"
  },
  ...
  "JOUR5_ALCHIMIE_FLUIDE__DANSE_DES_DAU": {
    avant: "Amener les tapis de yoga et le materiel natation",
    pendant: "",
    apres: "",
    updatedAt: "2026-08-25 03:37"
  },
  ...
  "JOUR5_AU_COMMENCEMENT_ETAIT_LE_CORPS": {
    avant: "Placer les matelas et les coussins dans la salle. <br>Installer des assiettes en carton pour poser l'huile de massage et quelques feuilles d'essui main à côté de chaque matelas<br>Faire un test son (enceintes, micro, musique)",
    pendant: "Sauger les participants à leur arrivée <br>Tenir l'espace<br>Signaler à l'animateur les besoins des participants et les éventuels débordements <br>Désinfecter absolument les mains des participants avant qu'ils ne quittent leur matelas, pendant l'atelier ou à la fin.",
    apres: "Distribuer les cartes de Sandrine<br>Ranger la salle",
    updatedAt: "2026-08-26 18:36"
  },
  ...
  "JOUR5_GROUNDING___INTEGRATIVE_MOVEME": {
    avant: "cleansing the space with sage or palo santo and making sure floors are swept",
    pendant: "-",
    apres: "-",
    updatedAt: "2026-08-25 03:58"
  },
  ...
  "JOUR5_L_ART_DE_DEVENIR_UN_AMANT_D_EX": {
    avant: "Installer les matelas et les chaises",
    pendant: "Distribuer masques pour les yeux pour chaque partenaire.<br>Certaines personnes pourraient avoir besoin d’aide pour se mettre en position « yab-yum ». Cela peut s’avérer un peu compliqué pour certains. Si les assistants connaissent cette position, ils pourront aider ceux qui auraient du mal à voir nos corps de face.",
    apres: "",
    updatedAt: "2026-08-26 18:36"
  },

  "JOUR5_PREPARATION_RASSEMBLEMENT": {
    avant: "",
    pendant: "",
    apres: "",
    updatedAt: "2026-08-25 10:14"
  ...
  "JOUR5_TANTRA_CAFE___TOUT_CE_QUE_VOUS": {
    avant: "Préparer les matelas et coussins pour faire un espace super cozy. <br>Ecrire des questions et les poster dans la boite. <br>Faire un test son (enceintes, micro, musique)",
  ...
  "JOUR5____STAND__MAQUILLAGE____": {
    avant: "",
    pendant: "",
    apres: "",
  ...
  "JOUR6_LOVING_LEADERSHIP_": {
    avant: "Ajuster le placement des chaise  10min avant l'atelier.<br>Sound check avant<br>Installer des spots (voir avec Felix)",
    pendant: "disposer les chaises près de la scène, en gradins. En fonction de l’espace disponible, nous pourrons organiser des activités impliquant des déplacements autour des chaises ou demander aux participants de les déplacer sur le côté si nécessaire.<br>Mic runners",
    apres: "Ranger les chaises",
    updatedAt: "2026-08-26 18:36"
  },

  "JOUR6_L_ART_D_ETRE_EN_MOUVEMENT_": {
    avant: "S'assurer que le sol est PROPRE ! <br>Ventiler l'espace un maximum avant l'atelier",
    pendant: "Tu peux découvrir et pratiquer avec le groupe",
    apres: "Orienter les festivaliers à venir vers moi, fin de l'atelier ou tout autre moment pendant le festival, pour tout autre demande.",
    updatedAt: "2026-08-25 03:37"
  },
  ...
  "JOUR6_THE_TEMPLE_OF_EROTIC_INNOCENCE": {
    ...
    apres: "clearing space",
    updatedAt: "2026-08-25 03:58"
  },

  "JOUR6_UN_BAIN_DE_GUERISON_CORPS_ET_A": {
  ...
  "LOG_Jour2_PLONGEZ_DANS_L_EXPERIENCE___DU_2": {
    ...
    apres: "Ranger la salle",
    updatedAt: "2026-08-26 15:57"
  },

  "LOG_Jour2_RASSEMBLEMENT": {
    avant: "AVANT — RENDEZ-VOUS À 9H25<br><br>Les helpers affectés au rassemblement doivent être présents 20 minutes avant le début.<br><br>• Ouvrir et installer correctement les bâches.<br><br>• Aérer la salle si nécessaire.<br><br>• Allumer un peu d’encens, dans le respect des consignes du lieu et en restant attentif aux personnes sensibles aux odeurs.<br><br>• Vérifier que l’espace est propre, agréable et dégagé.<br><br>• Passer un coup de balai si nécessaire.<br><br>• Ranger et disposer harmonieusement les coussins.<br><br>• Dégager les passages, les entrées et les sorties de secours.<br><br>• Vérifier qu’aucun objet dangereux ou inutile ne reste au sol.<br><br>• Préparer l’espace nécessaire à l’accueil dansé et aux prises de parole.<br><br>• Vérifier avec les maîtres de cérémonie s’ils ont besoin de matériel, de micros, d’eau ou d’un soutien particulier.<br><br>• Accueillir progressivement les festivaliers et les inviter à entrer dans l’espace.<br><br>L’objectif est que Shiva soit entièrement prêt, propre et accueillant avant l’arrivée du groupe.",
    pendant: "",
    apres: "",
    updatedAt: "2026-08-25 10:13"
  },
  ...
  "LOG_Jour5_ROUE_DU_FEU___LIBERATION_EMOTI": {
    ...
    pendant: "Présence soutenante et encouragements (voix, tambours...)<br><br>Installation des tapis et coussins en lignes avec espacement pour la partie 2.<br><br>Ecarter les tapis pour la partie 3.<br><br>1/ Echauffement de l'énergie, dynamiques synergétiques, ancrages et puissance 20'<br>2/ Demo et pratique des outils de libération 30'<br>3/ partage 10'<br>4/ haka kali 25'<br>5/ Intégration 5'",
    apres: "bien ranger",
    updatedAt: "2026-08-25 03:58"
  },
  ...
  "LOG_Jour6_CONFERENCE___POUR_UN_TANTRA_D_": {
    avant: "Installer un tapis de matelas avec plein de coussins posés dessus.",
    pendant: "",
    apres: "Ranger les matelas et les coussins",
    updatedAt: "2026-08-25 03:37"
  },

  "LOG_Jour6_CONTACT_MEETS_TANTRA": {
    avant: "Préparer le son, surtout si musicien",
    pendant: "",
    apres: "Ranger salle",
    updatedAt: "2026-08-25 03:37"
  },
