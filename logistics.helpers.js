...
var LOGISTICS_HELPERS = {
  ...
  "JOUR2_MEETING_YOUR_DEITY___HYPNOSIS_": {
    avant: "Test the sound system.<br>Install mattresses and chairs.",
    pendant: "During the workshop, helpers may sit in the first part of hypnosis. <br>Angels to support if anyone needs help in the hypnosis portion.",
    apres: "Participants may be need support from helpers in organizing their art materials or making their collage.",
    updatedAt: "2026-08-25 03:58"
  },
  ...
  "JOUR2_OPENING_CONNECTIONS": {
    avant: "May want someone to adjust chairs depending on number of participants.",
    pendant: "I will ask the assistants to pass out blindfolds to the participants.",
  ...
  "JOUR4_RELEASING_SEXUAL_SHAME___CONDI": {
    avant: "Test the sound system. <br>Install chairs",
    pendant: "During the workshop, helpers may be needed to move chairs back, but we depending on group size, chairs may remain in a circle.Angels will be most essential for hugs or supporting with tisses or check ins during &amp; after workshop. This workshop often brings up big emotions",
    apres: "Angels will be most essential for hugs or supporting with tisses or check ins during &amp; after workshop. This workshop often brings up big emotions",
    updatedAt: "2026-08-25 03:58"
  },
  ...
  "JOUR5_AU_COMMENCEMENT_ETAIT_LE_CORPS": {
    avant: "placer les matelas et les coussins dans la salle. smudger les participants lorsqu'ils arrivent. installer des petits récipents pour poser l'huile et quelques feuilles d'essui main à côté de chaque matelas. test son.",
    pendant: "tenir l'espace, me faire remarquer les besoins des participants et les éventuels débordements. absolument désinfecter les mains des participants avant qu'ils ne quittent leur matelas, pendant l'atelier ou à la fin.",
    apres: "distribuer les cartes et ranger la salle",
    updatedAt: "2026-08-25 03:58"
  },
