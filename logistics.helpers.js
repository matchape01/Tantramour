...
var LOGISTICS_HELPERS = {
  ...
  "JOUR2_L_UNION_SACREE_D_HATHOR_ET_HOR": {
    ...
    apres: "rangement du matériel, nettoyage de salle",
    updatedAt: "2026-08-18 23:48"
  },
  ...
  "JOUR3_POOL_PARTY_____DJ_PASCAL_DE_LA": {
    avant: "Installer la sono à cote de la piscine&nbsp;(voir avec Felix et le DJ). Créer un espace pour que les gens dansent autour de la piscine.",
  ...
  "JOUR3_THE_SPACE_BETWEEN_US__3HRS_": {
    avant: "Place mattresses and cushions, smudger the room<br>we will need two spaces that will become one, men and women will meet together in one space first and then move into a space on their own, and then come back together after about an hour apart. Myself and Guy will both need sound systems in our individual rooms, and head mics or mics that we can use while guiding. Then when we are in the same room we will need both mics to be in the same room together.",
    pendant: "we will need helpers to bring men to one room, women to other and assist them to come back together. We can keep women in the main room where the men will come back to. We will start all together in the women's room and the men will need to leave to go to another room and then come back to us.",
    apres: "-",
    updatedAt: "2026-08-18 23:48"
  },
  ...
  "JOUR5_POOL_PARTY___DJ_JUAN_FELIX": {
    avant: "<div>Installation sono (voir avec le DJ et Felix)</div><div>Créer un espace de danse autour de la piscine</div>",
    pendant: "A clarifier avec le DJ",
    apres: "Ranger la sono (voir avec le DJ et Felix)",
