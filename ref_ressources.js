...
var REF_RESSOURCES = [
  ...
  { id: "R_AMANA",           value: "Amana (William Duplain)",                   roles: ["facilitateur", "helper", "traducteur", "colibri"],      langues: ["FR", "EN"] },
  { id: "R_MATTHIEU",        value: "Atman Clochette (Matthieu Chapeleau)",      roles: ["facilitateur", "helper", "admin", "manager"],           langues: ["FR"] },
  { id: "R_AUDREY",          value: "Audrey Barthelemy",                         roles: ["facilitateur", "helper", "colibri"],                    langues: ["FR"] },
  { id: "R_AURELIE",         value: "Aurelie Lechardeur",                        roles: ["helper", "angel"],                                      langues: ["FR"], tel: "" },
  { id: "R_ALEXANDRE_R",     value: "Bhaskar (Alexandre Roque)",                 roles: ["helper", "traducteur"],                                 langues: ["FR", "EN"] },
  { id: "R_BORIS",           value: "Boris Desvignes",                           roles: ["facilitateur", "helper", "angel"],                      langues: ["FR"], tel: "" },
  ...
  { id: "R_CLAUDE",          value: "Claude Brame",                              roles: ["facilitateur", "helper", "colibri", "guest"],           langues: ["FR"] },
  { id: "R_DAMIEN",          value: "Damien Eissen",                             roles: ["facilitateur", "helper"],                               langues: ["FR"] },
  { id: "R_DANIEL",          value: "Daniel Latapie",                            roles: ["facilitateur", "helper", "traducteur", "angel"],        langues: ["FR", "EN"], tel: "" },
  ...
  { id: "R_FELIX",           value: "Felix Ardevol",                             roles: ["facilitateur"],                                         langues: ["FR"] },
  ...
  { id: "R_HELENE",          value: "Helene Planquelle",                         roles: ["facilitateur", "helper", "traducteur", "colibri"],      langues: ["FR", "EN"] },
  { id: "R_ISHVARI",         value: "Ishvari",                                   roles: ["facilitateur", "helper", "colibri"],                    langues: ["FR", "EN"] },
  { id: "R_CLEMENT",         value: "Jivan Muti (Clement Victor)",               roles: ["facilitateur"],                                         langues: ["FR"] },
  ...
  { id: "R_LINDA",           value: "Linda Stachetti",                           roles: ["facilitateur", "helper", "traducteur", "angel"],        langues: ["FR", "EN"], tel: "" },
  ...
  { id: "R_MITSCH",          value: "Mitsch Kohn",                               roles: ["facilitateur", "helper", "traducteur", "colibri", "guest"], langues: ["EN"] },
  { id: "R_MUKTI",           value: "Mukti (Cecile Yvorel)",                     roles: ["helper", "traducteur", "angel"],                        langues: ["FR", "EN"], tel: "" },
  ...
  { id: "R_SANDRINE",        value: "Sandrine Bettinelli",                       roles: ["facilitateur", "helper", "traducteur", "colibri", "guest"], langues: ["FR", "EN"] },
  { id: "R_SCOTT",           value: "Scott McClure",                             roles: ["facilitateur", "anglophone", "guest"],                  langues: ["EN"] },
  { id: "R_SELMA",           value: "Selma (Celine Laroche)",                    roles: ["facilitateur", "helper", "traducteur", "colibri"],      langues: ["FR", "EN"] },
  ...
  { id: "R_STEPHANE",        value: "Stephane Ahmed",                            roles: ["facilitateur", "helper", "colibri"],                    langues: ["FR"] },
  { id: "R_EMMANUELLE",      value: "Suman (Emmanuelle Cueff)",                  roles: ["facilitateur", "helper", "colibri"],                    langues: ["FR", "EN"] },
  { id: "R_TEST",            value: "TEST",                                      roles: ["facilitateur", "helper", "traducteur", "angel", "admin", "manager"], langues: ["FR", "EN"], tel: "" },
  ...
  { id: "R_VIRGINIE",        value: "Virginie Bertrand",                         roles: ["facilitateur", "helper", "traducteur", "angel"],        langues: ["FR", "EN"], tel: "" },
